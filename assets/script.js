const translations = {
  en: {
    ...
    project_group_rok4: "RoK-4",
    project_group_rok3: "RoK-3",
    ...
    project_model: "Model-based walking experiments for humanoid robots, including torque-control-based biped walking.",
    project_rok3: "Early humanoid walking experiments, robot platform development, and biped-to-full-humanoid integration.",
    project_wbc_title: "Whole-Body and Model Predictive Control",
    project_wbc: "Whole-body control and model predictive control for balance, support transition, and walking control.",
    project_foot_title: "Foot Design",
    project_foot: "Foot mechanism design, variable stiffness sole research, and terrain adaptation for uneven terrain and slope walking.",
    ...
    pub_journal_title: "Journal Papers",
    pub_conference_title: "Conference Papers",
    pub_more: "Full publication list on Google Scholar",
    demos_eyebrow: "Videos",
    demos_title: "Videos and Demonstrations",
    demo_group_rok4: "RoK-4",
    demo_group_rok3: "RoK-3",
    demo_2: "RoK-4 RL-based real-world walking",
    demo_3: "RoK-4 full-mechanism MuJoCo simulation",
    demo_4: "ADAPT differential mechanism demonstration",
    demo_5: "Single-leg jumping motion generation",
    demo_status: "Media will be added later.",
    demos_note: "Additional videos and images will be added as research media becomes available.",
    cv_title: "Curriculum Vitae",
    cv_text: "English and Korean CV versions are available below.",
    cv_status_pdf: "English PDF available",
    cv_status_html: "HTML CVs available",
    cv_status_kr: "Korean CV available",
    cv_pdf: "English CV PDF",
    cv_pdf_ko: "Korean CV PDF",
    cv_html: "English HTML CV",
    cv_html_ko: "Korean HTML CV",
  ...
  ko: {
    ...
    project_model: "토크 제어 기반 이족 보행을 포함한 휴머노이드 로봇의 모델 기반 보행 실험입니다.",
    project_rok3: "초기 휴머노이드 보행 실험, 로봇 플랫폼 개발, 이족 플랫폼에서 전신 휴머노이드로의 확장 연구입니다.",
    project_wbc_title: "전신 제어 및 모델 예측 제어",
    project_wbc: "균형 제어, 지지 상태 전환, 보행 제어를 위한 전신 제어 및 모델 예측 제어 연구입니다.",
    project_foot_title: "발 구조 설계",
    project_foot: "비정형 지형과 경사면 보행을 위한 발 구조 설계, variable stiffness sole, 지형 적응 연구입니다.",
    project_jump_title: "단일 다리 점프 모션 계획",
    project_jump: "비선형 궤적 최적화와 kinodynamic planning을 활용한 동적 legged motion 계획 연구입니다.",
    project_videos: "영상",
    pub_eyebrow: "논문",
    pub_title: "논문",
    pub_journal_title: "국제 저널 논문",
    pub_conference_title: "국제 학회 논문",
    pub_more: "Google Scholar에서 전체 논문 보기",
    demos_eyebrow: "영상",
    demos_title: "영상 및 데모",
    demo_group_rok4: "RoK-4",
    demo_group_rok3: "RoK-3",
    demo_2: "RoK-4 RL 기반 실제 로봇 보행",
    demo_3: "RoK-4 full-mechanism MuJoCo 시뮬레이션",
    demo_4: "ADAPT 차동 메커니즘 데모",
    demo_5: "단일 다리 점프 모션 생성",
    demo_status: "미디어는 추후 추가 예정입니다.",
    demos_note: "연구 미디어가 준비되는 대로 추가 영상과 이미지를 보강할 예정입니다.",
    cv_title: "이력서",
    cv_text: "아래에서 영문 및 국문 CV를 확인할 수 있습니다.",
    cv_status_pdf: "영문 PDF 사용 가능",
    cv_status_html: "HTML CV 사용 가능",
    cv_status_kr: "국문 CV 사용 가능",
    cv_pdf: "영문 CV PDF",
    cv_pdf_ko: "국문 CV PDF",
    cv_html: "영문 HTML CV",
    cv_html_ko: "국문 HTML CV",
    contact_eyebrow: "연락처",
    contact_title: "연락처"
  }
};
